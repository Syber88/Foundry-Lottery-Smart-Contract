...
contract RaffleTest is Test {
    ...
    function testDontAllowPlayersEntryToRaffleWhileCalculating() public raffleEntered {
    ...
    function testCheckUpkepReturnsFalseIfRaffleIsNotOpen() public raffleEntered {
        raffle.performUpkeep("");
        (bool upkeepNeeded,) = raffle.checkUpkeep("");
        assert(!upkeepNeeded);
    }
